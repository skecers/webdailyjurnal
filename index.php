...
<body>
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
        <div class="container">
            <div class="d-sm-flex flex-sm-row-reverse align-items-center">
                <img src="img/gojo1.jpg" class="img-fluid" width="300" />
                <div>
        ...
        <div class="container">
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    <?php
        $sql = "SELECT gambar FROM article ORDER BY tanggal DESC";
        $hasil = $conn->query($sql); 
        $active = true;
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-center">
                <div class="p-3">
                    <img src="img/gojo1.jpg" class="rounded-circle border shadow" width="300" />
                </div>
                <div class="p-md-5 text-sm-start">
                    <h3 class="lead">A11.2023.14990</h3>
                    <h1 class="fw-bold">Syafiq Farras Syaufiq</h1>
    ...
    <footer id="footer" class="text-center p-5">
        ...
        <div>Syafiq Farras Syaufiq &copy; 2025</div>
    </footer>
    <!-- footer end -->
